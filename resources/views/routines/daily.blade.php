...
@section('content')
<div class="container">
    <h2 class="mb-4 shadow-sm p-3 rounded bg-white">Routines Quotidiennes</h2>
    ...
    <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text"><strong>Jours :</strong> {{ implode(', ', json_decode($routine->days, true) ?? []) }}</p>
                        <p class="card-text"><strong>Horaire :</strong> {{ $routine->start_time }} - {{ $routine->end_time }}</p>
        ...
        @empty
            <p class="text-center">Aucune routine quotidienne trouvée.</p>
        @endforelse
    </div>
</div>
@endsection
